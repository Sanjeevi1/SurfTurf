...
import SelectionForm from './herosearch';

interface HeroProps {
    isLoggedIn: boolean; // Add prop for user authentication status
}
                            ...
                            {!isLoggedIn ? (
                                <>
                                    <span
                                        ...
                                        role="button"
                                    >
                                        <Link to='/customer/turf'>Book Now</Link>
                                    ...
                                    <p className="mt-5 ml-3 text-black font-bold">New User??
                                        <a href="#" title="Log in" className="text-yellow-300 transition-all duration-200 hover:underline m-2">
